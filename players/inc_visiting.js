...
function visiting_opt_in() {
	...
	if (rsp.ok) {
		...
		this.sendActivity("You've been opted in - you will receive random visitors to your street.");
	}
	else {
...
function visiting_visit_random() {
	...
	if (ret.ok) {
		...
		this.sendActivity("We ran into a problem teleporting you to a street. Please try again!");
	}
}
