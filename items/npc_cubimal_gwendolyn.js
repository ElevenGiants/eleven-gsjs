...
var label = "Gwendolyn Cubimal";
var version = "1353719712";
var name_single = "Gwendolyn Cubimal";
var name_plural = "Gwendolyn Cubimals";
var article = "a";
var description = "It's a Gwendolyn Cubimal! Collect all Series 1 Cubimals!";
var is_hidden = false;
var has_info = true;
...
var base_cost = 0;
var input_for = [];
var parent_classes = ["npc_cubimal_gwendolyn", "npc_cubimal_base", "npc"];
...
function getAssetInfo(){
	return {
		'position': {"x":-17,"y":-25,"w":33,"h":26},
		'thumb': "",
	};
};
...
var itemDef = {
	...
	asset_swf_v	: "\/c2.glitch.bz\/items\/2012-07\/npc_cubimal_gwendolyn-1343767876.swf",
	admin_props	: true,
	obey_physics	: false,
	in_background	: false,
	in_foreground	: true,
...
log.info("npc_cubimal_gwendolyn.js LOADED");
