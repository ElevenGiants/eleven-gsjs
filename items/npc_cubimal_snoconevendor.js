...
var label = "Sno Cone Vendor Cubimal";
var version = "1353719712";
var name_single = "Sno Cone Vendor Cubimal";
var name_plural = "Sno Cone Vendor Cubimals";
var article = "a";
var description = "It's a Sno Cone Vendor Cubimal! Collect all Series 1 Cubimals!";
var is_hidden = false;
var has_info = true;
...
var base_cost = 0;
var input_for = [];
var parent_classes = ["npc_cubimal_snoconevendor", "npc_cubimal_base", "npc"];
var has_instance_props = true;

var classProps = {
	"got_quest_text"	: "I've got something for you...",	// defined by npc
	"no_quest_text"	: "",	// defined by npc
	"set_free_img"	: "1000"	// defined by npc_cubimal_base (overridden by npc_cubimal_snoconevendor)
};
...
function getAssetInfo(){
	return {
		...
		'thumb': "\n\/\/P1X5O9dZdiYxIaAAAAAElFTkSuQmCC",
	};
};
...
var itemDef = {
	...
	asset_swf_v	: "\/c2.glitch.bz\/items\/2012-07\/npc_cubimal_snoconevendor-1343768253.swf",
	admin_props	: true,
	obey_physics	: false,
	in_background	: false,
	in_foreground	: true,
...
log.info("npc_cubimal_snoconevendor.js LOADED");
