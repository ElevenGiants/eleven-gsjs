...
var label = "Dust Bunny";
var version = "1347655947";
var name_single = "Dust Bunny";
var name_plural = "Dust Bunnies";
var article = "a";
var description = "An ikkle fwuffy cutesy wutesy Dust Bunny. As cute as a small fluffy ball made of dead skin and discarded hair can be, at any rate. Still, at least it's polite.";
var is_hidden = false;
var has_info = true;
...
var base_cost = 0;
var input_for = [];
var parent_classes = ["npc_dustbunny", "npc_walkable", "npc"];
...
function idle_onRun(){ // defined by npc_dustbunny
...
function onCreate(){ // defined by npc_dustbunny
...
function startMoving(){ // defined by npc_dustbunny
	if (!this.container){
...
function walk_onMsg(msg){ // defined by npc_dustbunny
...
var itemDef = {
	...
	asset_swf_v	: "\/c2.glitch.bz\/items\/2010-02\/1267069553-9057.swf",
	admin_props	: true,
	obey_physics	: false,
	in_background	: false,
	in_foreground	: true,
...
log.info("npc_dustbunny.js LOADED");
