...
var name_single = "Dark Patch";
var name_plural = "Dark Patches";
var article = "a";
var description = "An underground patch. As in \"subterranean\", rather than \"clandestine\". Perfect for planting anything that flourishes in the shade. Or rather 'the one thing that flourishes in the shade'.";
var is_hidden = false;
var has_info = true;
...
var base_cost = 0;
var input_for = [];
var parent_classes = ["patch_dark", "patch"];
...
function getDescExtras(pc){
	var out = [];
	out.push([2, "You can tend this with a <a href=\"\/items\/95\/\" glitch=\"item|hoe\">Hoe<\/a>, dig it with a <a href=\"\/items\/627\/\" glitch=\"item|shovel\">Shovel<\/a> or plant an <a href=\"\/items\/102\/\" glitch=\"item|bean_egg\">Egg Plant Bean<\/a> in it."]);
	return out;
}
...
function getAssetInfo(){
	return {
		...
		'thumb': "",
	};
};
...
var itemDef = {
	...
	asset_swf_v	: "\/c2.glitch.bz\/items\/2010-12\/1291688068-4630.swf",
	admin_props	: true,
	obey_physics	: false,
	in_background	: true,
	in_foreground	: false,
