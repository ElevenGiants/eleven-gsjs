...
var label = "Wall Lamp";
var version = "1345828419";
var name_single = "Wall Lamp";
var name_plural = "Wall Lamps";
var article = "a";
var description = "For those who require a detailed, well-lit view of a small area of the wall, of anyone standing directly below the lamp, and of the lamp itself. A desirable feature.";
var is_hidden = false;
var has_info = true;
...
var base_cost = 600;
var input_for = [];
var parent_classes = ["furniture_walllamp", "furniture_base"];
var has_instance_props = true;

var classProps = {
	"placement_set"	: "wall",	// defined by furniture_base (overridden by furniture_walllamp)
...
function getAssetInfo(){
	return {
		'position': {"x":-22,"y":-72,"w":43,"h":72},
		'thumb': "",
	};
};
...
var itemDef = {
	...
	asset_swf_v	: "\/c2.glitch.bz\/items\/2012-02\/furniture_walllamp-1329432431.swf",
	admin_props	: true,
	obey_physics	: false,
	in_background	: false,
	in_foreground	: false,
