...
var name_single = "Counter";
var name_plural = "Counters";
var article = "a";
var description = "Why own a counter? Because it is an admirably flat surface, useful for dividing large spaces. (This is known as 'The Counter Argument'. A Counter-Counter Argument exists, but it only confuses everything).";
var is_hidden = false;
var has_info = true;
...
var base_cost = 925;
var input_for = [];
var parent_classes = ["furniture_counter", "furniture_base"];
var has_instance_props = true;

var classProps = {
	"placement_set"	: "bookshelf,chair",	// defined by furniture_base (overridden by furniture_counter)
...
function getFurnitureBaseGeo(){ // defined by furniture_counter
	//
	// this code generated by the furniture plat editor - do not overwrite!
	//

	return { 'plats': {"0":{"platform_pc_perm":-1,"end":{"x":65,"y":-42},"start":{"x":-67,"y":-41},"platform_item_perm":-1}},
	         'walls': null
	};
}
...
function getAssetInfo(){
	return {
		'position': {"x":-99,"y":-60,"w":199,"h":82},
		'thumb': "\n\/I9ZNtlkk022f9x+A+d4dxhWWK3lAAAAAElFTkSuQmCC",
	};
};
...
var itemDef = {
	...
	asset_swf_v	: "\/c2.glitch.bz\/items\/2012-07\/furniture_counter-1342477514.swf",
	admin_props	: true,
	obey_physics	: false,
	in_background	: false,
	in_foreground	: false,
...
log.info("furniture_counter.js LOADED");
