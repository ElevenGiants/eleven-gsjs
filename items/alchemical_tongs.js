...
var label = "Alchemical Tongs";
var version = "1355086256";
var name_single = "Alchemical Tongs";
var name_plural = "Alchemical Tongs";
var article = "an";
var description = "Handy bendy Alchemical Tongs help you to create exciting metals like <a href=\"\/items\/617\/\" glitch=\"item|tin\">Tin<\/a>, <a href=\"\/items\/618\/\" glitch=\"item|copper\">Copper<\/a> and <a href=\"\/items\/619\/\" glitch=\"item|molybdenum\">Molybdenum<\/a> by adding elements to boring old hot smelted metal.";
var is_hidden = false;
var has_info = true;
...
var base_cost = 600;
var input_for = [];
var parent_classes = ["alchemical_tongs", "tool_base", "takeable"];
var has_instance_props = true;

var classProps = {
	"collection_id"	: "",	// defined by takeable
	"making_type"	: "",	// defined by tool_base
	"required_skill"	: "alchemy_2",	// defined by tool_base (overridden by alchemical_tongs)
	"points_capacity"	: "100",	// defined by tool_base (overridden by alchemical_tongs)
	"display_wear"	: "1",	// defined by tool_base (overridden by alchemical_tongs)
	"can_repair"	: "1"	// defined by tool_base
};

function initInstanceProps(){
	this.instanceProps = {};
	this.instanceProps.points_remaining = "100";	// defined by tool_base (overridden by alchemical_tongs)
...
verbs.rub = { // defined by alchemical_tongs
	"name"				: "rub",
	"ok_states"			: ["in_pack"],
	"requires_target_pc"		: false,
	"requires_target_item"		: false,
	...
	"is_emote"			: false,
	"sort_on"			: 56,
	"tooltip"			: "Convert plain metal to other kinds",
	"is_drop_target"		: false,
	"making"			: {
		slots		: 4,
		try_wait	: 5,
		recipes		: [174, 175, 176, 263],
		skills		: ["alchemy_2"],
		can_discover	: false,
	...
	"conditions"			: function(pc){
		...
		return pc.making_check_allowed(this, "rub");
	},
	"effects"			: function(pc){

		return pc.making_get_effects(this, "rub");
	},
	"handler"			: function(pc, msg, suppress_activity){

		return pc.making_open_interface(this, "rub");
	}
};

function onMakingComplete(pc, recipe_id, count){ // defined by alchemical_tongs
	var chance_of_bonus = 0.12;
	var bonus_base_cost_percentage = 0.15;
	var upgrade_id = 'alchemy_2_imagination';
...
function getDescExtras(pc){
	var out = [];
	if (pc && (!pc.skills_has("alchemy_2"))) out.push([1, "You need the skill <a href=\"\/skills\/81\/\" glitch=\"skill|alchemy_2\">Alchemy II<\/a> to use this."]);
...
function getAssetInfo(){
	return {
		'position': {"x":-26,"y":-14,"w":51,"h":14},
		'thumb': "",
	};
};
...
var itemDef = {
	...
	asset_swf_v	: "\/c2.glitch.bz\/items\/2012-04\/alchemical_tongs-1334268139.swf",
	admin_props	: true,
	obey_physics	: true,
	in_background	: false,
	in_foreground	: false,
...
log.info("alchemical_tongs.js LOADED");
