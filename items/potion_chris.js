...
var label = "Door Drink";
var version = "1355086256";
var name_single = "Door Drink";
var name_plural = "Door Drinks";
var article = "a";
var description = "The most bewildering of all potions, the dark alchemical secrets brewed into this potent brew can produce (and destroy) mysterious doors to far-off lands. You'll find yourself leaping from place to place, never knowing where the next leap may lead you.";
var is_hidden = false;
var has_info = true;
...
var base_cost = 750;
var input_for = [];
var parent_classes = ["potion_chris", "potion_base", "tool_base", "takeable"];
...
var classProps = {
	...
	"points_capacity"	: "3",	// defined by tool_base (overridden by potion_chris)
	"display_wear"	: "1",	// defined by tool_base
	"can_repair"	: "0",	// defined by tool_base
	"can_pour"	: "1",	// defined by potion_base (overridden by potion_chris)
	"can_quaff"	: "0",	// defined by potion_base
	"pour_tooltip"	: "Open a door to adventure",	// defined by potion_base (overridden by potion_chris)
	"quaff_tooltip"	: ""	// defined by potion_base
};

function initInstanceProps(){
	this.instanceProps = {};
	this.instanceProps.points_remaining = "3";	// defined by tool_base (overridden by potion_chris)
...
function canPour(pc){ // defined by potion_chris
	/*if (pc.location.pols_is_pol() ||
	    pc.location.isInstance() ||
	    pc.location.isInHell() ||
	    pc.location.is_hidden() ||
	    pc.location.no_teleportation){
		return {ok: 0, error:'You can\'t pour this potion here.'};
	}*/

	// http://bugs.tinyspeck.com/10508
	if (pc.location.pols_is_pol() ||
	    pc.location.isInstance() ||
	    pc.location.isInHell()){
		return {ok: 0, error:'You can\'t pour this potion here.'};
...
function onPour(pc){ // defined by potion_chris
	var portal_group = apiFindObject(config.portal_group);
	if (!portal_group) return {ok:0, error:'Could not find portal_group'};

	portal_group.create_portal(pc.location, pc.x, pc.y);
...
function getAssetInfo(){
	return {
		...
		'thumb': "",
	};
};
...
var itemDef = {
	...
	asset_swf_v	: "\/c2.glitch.bz\/items\/2012-04\/potion_chris-1334269829.swf",
	admin_props	: true,
	obey_physics	: true,
	in_background	: false,
	in_foreground	: false,
...
log.info("potion_chris.js LOADED");
