...
var label = "Smuggler Cubimal";
var version = "1353719712";
var name_single = "Smuggler Cubimal";
var name_plural = "Smuggler Cubimals";
var article = "a";
var description = "It's a Smuggler Cubimal! Collect all Series 1 Cubimals!";
var is_hidden = false;
var has_info = true;
...
var base_cost = 0;
var input_for = [];
var parent_classes = ["npc_cubimal_smuggler", "npc_cubimal_base", "npc"];
...
function getAssetInfo(){
	return {
		'position': {"x":-17,"y":-26,"w":34,"h":26},
		'thumb': "",
	};
};
...
var itemDef = {
	...
	asset_swf_v	: "\/c2.glitch.bz\/items\/2012-07\/npc_cubimal_smuggler-1343768247.swf",
	admin_props	: true,
	obey_physics	: false,
	in_background	: false,
	in_foreground	: true,
...
log.info("npc_cubimal_smuggler.js LOADED");
