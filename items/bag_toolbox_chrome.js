...
var label = "Chrome Toolbox";
var version = "1352136668";
var name_single = "Chrome Toolbox";
var name_plural = "Chrome Toolboxes";
var article = "a";
var description = "A sturdy, metal-y, chrome toolbox. It's a box. And you can put tools in it.";
var is_hidden = false;
var has_info = true;
...
var base_cost = 2500;
var input_for = [];
var parent_classes = ["bag_toolbox_chrome", "bag_toolbox_base", "bag_bigger", "takeable"];
...
function getFurnitureBaseGeo(){ // defined by bag_toolbox_chrome
	//
	// this code generated by the furniture plat editor - do not overwrite!
	//

	return { 'plats': {"0":{"end":{"x":-433,"y":-27},"start":{"x":-493,"y":-27},"platform_pc_perm":-1,"platform_item_perm":-1}},
	         'walls': null
	};
}
...
function getAssetInfo(){
	return {
		'position': {"x":-34,"y":-33,"w":65,"h":33},
		'thumb': "",
	};
};
...
var itemDef = {
	...
	asset_swf_v	: "\/c2.glitch.bz\/items\/2012-04\/bag_toolbox_chrome-1334339712.swf",
	admin_props	: false,
	obey_physics	: true,
	in_background	: false,
	in_foreground	: false,
