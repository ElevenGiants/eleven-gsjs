		...
		if (msg.target_itemstack_tsid) { 
			...
			if (this.countContents() < capacity && this.getNumPackagesTotal() < parseInt(this.getClassProp("package_limit"))) {
				...
				if (this.canContain(stack)) {
					...
					if (count > 1){
						text = this.getTextString("packageGivePlural", pc, owner, null, null, count + " " + stack.name_plural);
						var article = "these";
					}
					else {
						text = this.getTextString("packageGiveSingle", pc, owner, null, null, stack.name_single);
						var article = "this";
					}
...
var itemDef = {
	...
	asset_swf_v	: "\/c2.glitch.bz\/items\/2012-06\/bag_butler-1340661240.swf",
	admin_props	: true,
	obey_physics	: false,
	in_background	: false,
	in_foreground	: true,
