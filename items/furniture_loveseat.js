...
var name_single = "Loveseat";
var name_plural = "Loveseats";
var article = "a";
var description = "A loveseat for those who love seats in a moderate way. For those who really LOVE seats, upgrades to even more loveable seats are available.";
var is_hidden = false;
var has_info = true;
...
var base_cost = 1250;
var input_for = [];
var parent_classes = ["furniture_loveseat", "furniture_base"];
var has_instance_props = true;

var classProps = {
	"placement_set"	: "bookshelf,chair",	// defined by furniture_base (overridden by furniture_loveseat)
...
function getFurnitureBaseGeo(){ // defined by furniture_loveseat
	//
	// this code generated by the furniture plat editor - do not overwrite!
	//

	return { 'plats': {"0":{"end":{"y":-22,"x":69},"start":{"y":-22,"x":-71},"platform_pc_perm":-1,"platform_item_perm":-1}},
	         'walls': null
	};
}
...
function getAssetInfo(){
	return {
		'position': {"x":-92,"y":-76,"w":184,"h":99},
		'thumb': "",
	};
};
...
var itemDef = {
	...
	asset_swf_v	: "\/c2.glitch.bz\/items\/2012-02\/furniture_loveseat-1329427903.swf",
	admin_props	: true,
	obey_physics	: false,
	in_background	: false,
	in_foreground	: false,
...
log.info("furniture_loveseat.js LOADED");
