...
var name_single = "Desk";
var name_plural = "Desks";
var article = "a";
var description = "For those who aspire to life in the bureaucratic hall, even a basic starter desk can induce the feelings of power previously known only to the administrators of Ur.";
var is_hidden = false;
var has_info = true;
...
var base_cost = 1050;
var input_for = [];
var parent_classes = ["furniture_desk", "furniture_base"];
var has_instance_props = true;

var classProps = {
	"placement_set"	: "bookshelf,chair",	// defined by furniture_base (overridden by furniture_desk)
...
function getFurnitureBaseGeo(){ // defined by furniture_desk
	//
	// this code generated by the furniture plat editor - do not overwrite!
	//

	return { 'plats': {"0":{"end":{"y":-41,"x":58},"start":{"y":-41,"x":-61},"platform_pc_perm":-1,"platform_item_perm":-1}},
	         'walls': null
	};
}
...
function getAssetInfo(){
	return {
		'position': {"x":-95,"y":-51,"w":189,"h":73},
		'thumb': "",
	};
};
...
var itemDef = {
	...
	asset_swf_v	: "\/c2.glitch.bz\/items\/2012-03\/furniture_desk-1330991540.swf",
	admin_props	: true,
	obey_physics	: false,
	in_background	: false,
	in_foreground	: false,
...
log.info("furniture_desk.js LOADED");
