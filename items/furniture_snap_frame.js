...
var label = "Snap Frame";
var version = "1345763870";
var name_single = "Snap Frame";
var name_plural = "Snap Frames";
var article = "a";
var description = "";
var is_hidden = false;
var has_info = false;
...
var base_cost = 0;
var input_for = [];
var parent_classes = ["furniture_snap_frame", "furniture_base"];
var has_instance_props = true;

var classProps = {
	"placement_set"	: "wall",	// defined by furniture_base (overridden by furniture_snap_frame)
...
function getExtraConfig(ret){ // defined by furniture_snap_frame
	var snap_sd = {
		uid: 'snap_frame_'+this.tsid,
		item_class: null,
		type: 'snap_frame'
	}
	...
	if (true) {
		snap_sd.img_url = 'http://c6.glitch.bz/photos/2012-06-24/PCR2HLTMPIL11HJ/29846_74a831cf0e_t.jpg';
		snap_sd.delta_x = 0;
		snap_sd.delta_y = 0;
		snap_sd.center_view = true;
		snap_sd.fade_out_sec = 0;
		snap_sd.under_itemstack = false;
		snap_sd.width = ret.snap_w;
		snap_sd.height = ret.snap_h;
		snap_sd.delta_y = -((ret.snap_h/2)+15);
	}

	// order of array governs z depth of special displays
	ret.special_display = [snap_sd];
...
function getAssetInfo(){
	return {
		'position': {"x":-65,"y":-130,"w":130,"h":130},
		'thumb': "",
	};
};
...
var itemDef = {
	...
	asset_swf_v	: "\/c2.glitch.bz\/items\/2012-06\/furniture_snap_frame-1340514206.swf",
	admin_props	: true,
	obey_physics	: false,
	in_background	: false,
	in_foreground	: false,
