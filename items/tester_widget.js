...
verbs.cash = {
	...
	"handler"			: function(pc, msg, suppress_activity){
		var choices = {
			1: {value: 'currants_1000', txt: 'some (1k)'},
			2: {value: 'currants_10000', txt: 'some more (10k)'},
			3: {value: 'currants_100000', txt: 'moar! (100k)'},
		};
		pc.apiSendMsgAsIs({
			type: 'conversation',
			itemstack_tsid: this.id,
...
verbs.items = {
	...
	"handler"			: function(pc, msg, suppress_activity){
		var choices = {
			...
			8: {value: 'items_general_building_permit', txt: 'Permit'},
		};
		pc.apiSendMsgAsIs({
			type: 'conversation',
			itemstack_tsid: this.id,
...
verbs.img = {
	...
	"handler"			: function(pc, msg, suppress_activity){
		var choices = {
			1: {value: 'img_1000', txt: 'some (1k)'},
			2: {value: 'img_10000', txt: 'some more (10k)'},
			3: {value: 'img_100000', txt: 'moar! (100k)'},
		};
		pc.apiSendMsgAsIs({
			type: 'conversation',
			itemstack_tsid: this.id,
...
verbs.credits = {
	...
	"handler"			: function(pc, msg, suppress_activity){
		var choices = {
			1: {value: 'credits_1000', txt: 'some (1k)'},
			2: {value: 'credits_10000', txt: 'some more (10k)'},
			3: {value: 'credits_100000', txt: 'moar! (100k)'},
		};
		pc.apiSendMsgAsIs({
			type: 'conversation',
			itemstack_tsid: this.id,
