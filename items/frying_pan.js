...
var label = "Frying Pan";
var version = "1355086256";
var name_single = "Frying Pan";
var name_plural = "Frying Pans";
var article = "a";
var description = "A useful pan for frying things in.";
var is_hidden = false;
var has_info = true;
...
var base_cost = 125;
var input_for = [];
var parent_classes = ["frying_pan", "tool_base", "takeable"];
var has_instance_props = true;

var classProps = {
	"collection_id"	: "",	// defined by takeable
	"making_type"	: "cooking",	// defined by tool_base (overridden by frying_pan)
	"required_skill"	: "cheffery_1",	// defined by tool_base (overridden by frying_pan)
	"points_capacity"	: "100",	// defined by tool_base (overridden by frying_pan)
	"display_wear"	: "1",	// defined by tool_base (overridden by frying_pan)
	"can_repair"	: "1"	// defined by tool_base
};

function initInstanceProps(){
	this.instanceProps = {};
	this.instanceProps.points_remaining = "100";	// defined by tool_base (overridden by frying_pan)
...
verbs.fry = { // defined by frying_pan
	"name"				: "fry",
	"ok_states"			: ["in_pack"],
	"requires_target_pc"		: false,
	"requires_target_item"		: false,
	...
	"is_emote"			: false,
	"sort_on"			: 56,
	"tooltip"			: "Use the pan. You know $recipes_known recipes",
	"is_drop_target"		: false,
	"making"			: {
		slots		: 4,
		try_wait	: 5,
		recipes		: [2, 3, 4, 5, 6, 10, 17, 18, 19, 20, 81, 82, 83, 84, 86, 87, 88, 89, 90, 92, 139, 140, 141, 227, 288, 329, 330, 331, 332, 333, 350],
		skills		: ["cheffery_1", "cheffery_2", "cheffery_3"],
		can_discover	: false,
		specify_quantities	: false,
	},
	"conditions"			: function(pc){

		return pc.making_check_allowed(this, "fry");
	},
	"effects"			: function(pc){

		return pc.making_get_effects(this, "fry");
	},
	"handler"			: function(pc, msg, suppress_activity){

		return pc.making_open_interface(this, "fry");
	}
};

function getHitPointModifier(pc){ // defined by frying_pan
	if (pc.imagination_has_upgrade('cheffery_tool_wear')) return 0.5;

	return 1;
}

function onMakingComplete(pc, recipe_id, count){ // defined by frying_pan
	var chance_of_bonus = 0.10;
	var bonus_base_cost_percentage = 0.20;
	var upgrade_id = 'cheffery_imagination';
...
function getDescExtras(pc){
	var out = [];
	if (pc && (!pc.skills_has("cheffery_1"))) out.push([1, "You need the skill <a href=\"\/skills\/36\/\" glitch=\"skill|cheffery_1\">Cheffery I<\/a> to use this."]);
	if (pc && (!pc.achievements_has("sizzler_supreme"))) out.push([2, "Additional recipes will become available if you use the Frying Pan more."]);
...
function getAssetInfo(){
	return {
		'position': {"x":-46,"y":-25,"w":91,"h":25},
		'thumb': "",
	};
};
