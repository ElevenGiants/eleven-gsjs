...
var name_single = "Armchair";
var name_plural = "Armchairs";
var article = "an";
var description = "A basic armchair. Like a normal chair, but armed. Armed and dangerous. If by \"dangerous\" you mean \"quite uncomfortable.\"";
var is_hidden = false;
var has_info = true;
...
var base_cost = 1000;
var input_for = [];
var parent_classes = ["furniture_armchair", "furniture_base"];
var has_instance_props = true;

var classProps = {
	"placement_set"	: "bookshelf,chair",	// defined by furniture_base (overridden by furniture_armchair)
...
function getFurnitureBaseGeo(){ // defined by furniture_armchair
	//
	// this code generated by the furniture plat editor - do not overwrite!
	//

	return { 'plats': {"0":{"end":{"x":42,"y":-22},"start":{"x":-14,"y":-17},"platform_pc_perm":-1,"platform_item_perm":-1}},
	         'walls': null
	};
}
...
function getAssetInfo(){
	return {
		'position': {"x":-61,"y":-65,"w":122,"h":91},
		'thumb': "",
	};
};
