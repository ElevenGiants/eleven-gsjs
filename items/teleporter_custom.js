var label = "Collision-Triggered Teleporter w\/ Code";
var version = "1349114019";
var name_single = "Collision-Triggered Teleporter w\/ Code";
var name_plural = "";
var article = "a";
var description = "";
var is_hidden = true;
...
var base_cost = 0;
var input_for = [];
var parent_classes = ["teleporter_custom", "teleporter"];
...
function initInstanceProps(){
	...
	this.instanceProps.collideCode = "1";	// defined by teleporter_custom
}
...
var instancePropsDef = {
	...
	collideCode : ["Code to run on collision"],
};
...
function onPlayerCollision(pc){ // defined by teleporter_custom
	log.info('Player '+pc+' collided with teleporter');

	eval(this.instanceProps.collideCode);
}
...
function parent_onPlayerCollision(pc){ // defined by teleporter
...
log.info("teleporter_custom.js LOADED");
