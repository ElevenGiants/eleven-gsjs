...
var name_single = "Hoe";
var name_plural = "Hoes";
var article = "a";
var description = "A garden-variety hoe. It can be used to tend weedy patches.";
var is_hidden = false;
var has_info = true;
...
var base_cost = 60;
var input_for = [];
var parent_classes = ["hoe", "tool_base", "takeable"];
...
var classProps = {
	...
	"points_capacity"	: "50",	// defined by tool_base (overridden by hoe)
	"display_wear"	: "1",	// defined by tool_base (overridden by hoe)
	"can_repair"	: "1"	// defined by tool_base
};

function initInstanceProps(){
	this.instanceProps = {};
	this.instanceProps.points_remaining = "50";	// defined by tool_base (overridden by hoe)
...
function getDescExtras(pc){
	var out = [];
	if (pc && (!pc.skills_has("soil_appreciation_1"))) out.push([2, "You can use this, but it's much better to learn <a href=\"\/skills\/1\/\" glitch=\"skill|soil_appreciation_1\">Soil Appreciation I<\/a> first."]);
...
function getAssetInfo(){
	return {
		'position': {"x":-35,"y":-24,"w":70,"h":24},
		'thumb': "",
	};
};
...
var itemDef = {
	...
	asset_swf_v	: "\/c2.glitch.bz\/items\/2012-05\/hoe-1338243631.swf",
	admin_props	: true,
	obey_physics	: true,
	in_background	: false,
	in_foreground	: false,
