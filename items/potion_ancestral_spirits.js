...
var label = "Ancestral Spirits";
var version = "1355086256";
var name_single = "Ancestral Spirits";
var name_plural = "Ancestral Spirits";
var article = "an";
var description = "Steadies the nerves and steels the soul against the onset of Ancestral Nostalgia.";
var is_hidden = false;
var has_info = true;
...
var base_cost = 1850;
var input_for = [];
var parent_classes = ["potion_ancestral_spirits", "potion_base", "tool_base", "takeable"];
...
var classProps = {
	...
	"points_capacity"	: "1",	// defined by tool_base (overridden by potion_ancestral_spirits)
	"display_wear"	: "0",	// defined by tool_base (overridden by potion_ancestral_spirits)
	"can_repair"	: "0",	// defined by tool_base
	"can_pour"	: "0",	// defined by potion_base
	"can_quaff"	: "1",	// defined by potion_base (overridden by potion_ancestral_spirits)
	"pour_tooltip"	: "",	// defined by potion_base
	"quaff_tooltip"	: "Spend more quality time with your ancestors"	// defined by potion_base (overridden by potion_ancestral_spirits)
};
...
function canQuaff(pc){ // defined by potion_ancestral_spirits
	if (!pc.buffs_has("ancestral_nostalgia")) return {ok:0, error: "You can only drink this in the Ancestral Lands."};
	if (pc.baqala_times && pc.baqala_times.potion_used) return {ok:0, error: "You can only use this once per visit."};
	return {ok:1};
}

function onQuaff(pc, msg){ // defined by potion_ancestral_spirits
	pc.give_baqala_time(300);
	pc.baqala_times.potion_used = true;
	return {ok:1, msg: "Your nostalgia subsides somewhat."};
}
...
function getAssetInfo(){
	return {
		...
		'thumb': "",
	};
};
...
var itemDef = {
	...
	asset_swf_v	: "\/c2.glitch.bz\/items\/2012-04\/potion_ancestral_spirits-1334269729.swf",
	admin_props	: true,
	obey_physics	: true,
	in_background	: false,
	in_foreground	: false,
