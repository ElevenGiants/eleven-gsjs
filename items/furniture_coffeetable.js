...
var label = "Coffee Table";
var version = "1345763869";
var name_single = "Coffee Table";
var name_plural = "Coffee Tables";
var article = "a";
var description = "A starter table for those who enjoy the concept of resting their brew on an almost flat surface. For those who dream of an *actually* flat one, upgrades are available.";
var is_hidden = false;
var has_info = true;
...
var base_cost = 1100;
var input_for = [];
var parent_classes = ["furniture_coffeetable", "furniture_base"];
var has_instance_props = true;

var classProps = {
	"placement_set"	: "bookshelf,chair",	// defined by furniture_base (overridden by furniture_coffeetable)
...
function getFurnitureBaseGeo(){ // defined by furniture_coffeetable
	//
	// this code generated by the furniture plat editor - do not overwrite!
	//

	return { 'plats': {"0":{"end":{"y":-18,"x":86},"start":{"y":-18,"x":-74},"platform_pc_perm":-1,"platform_item_perm":-1}},
	         'walls': null
	};
}
...
function getAssetInfo(){
	return {
		'position': {"x":-143,"y":-35,"w":287,"h":63},
		'thumb': "",
	};
};
...
var itemDef = {
	...
	asset_swf_v	: "\/c2.glitch.bz\/items\/2012-03\/furniture_coffeetable-1330991375.swf",
	admin_props	: true,
	obey_physics	: false,
	in_background	: false,
	in_foreground	: false,
...
log.info("furniture_coffeetable.js LOADED");
