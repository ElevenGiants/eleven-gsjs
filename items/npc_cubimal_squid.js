...
var label = "Squid Cubimal";
var version = "1353719712";
var name_single = "Squid Cubimal";
var name_plural = "Squid Cubimals";
var article = "a";
var description = "It's a Squid Cubimal! Collect all Series 1 Cubimals!";
var is_hidden = false;
var has_info = true;
...
var base_cost = 0;
var input_for = [];
var parent_classes = ["npc_cubimal_squid", "npc_cubimal_base", "npc"];
var has_instance_props = true;

var classProps = {
	"got_quest_text"	: "I've got something for you...",	// defined by npc
	"no_quest_text"	: "",	// defined by npc
	"set_free_img"	: "1000"	// defined by npc_cubimal_base (overridden by npc_cubimal_squid)
};
...
function getAssetInfo(){
	return {
		...
		'thumb': "",
	};
};
...
var itemDef = {
	...
	asset_swf_v	: "\/c2.glitch.bz\/items\/2012-07\/npc_cubimal_squid-1343768265.swf",
	admin_props	: true,
	obey_physics	: false,
	in_background	: false,
	in_foreground	: true,
...
log.info("npc_cubimal_squid.js LOADED");
