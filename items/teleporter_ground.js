...
var base_cost = 0;
var input_for = [];
var parent_classes = ["teleporter_ground", "teleporter_visible", "teleporter"];
...
function getCreationTime(){ // defined by teleporter_ground
	return this.ts;
}
...
var itemDef = {
	...
	asset_swf_v	: "\/c2.glitch.bz\/items\/2011-11\/teleporter_ground-1322014043.swf",
	admin_props	: true,
	obey_physics	: false,
	in_background	: true,
	in_foreground	: false,
...
log.info("teleporter_ground.js LOADED");
