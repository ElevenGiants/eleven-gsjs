...
var label = "Awesome Pot";
var version = "1355086256";
var name_single = "Awesome Pot";
var name_plural = "Awesome Pots";
var article = "an";
var description = "An awesome pot is used to make special dishes. Very special.";
var is_hidden = false;
var has_info = true;
...
var base_cost = 300;
var input_for = [];
var parent_classes = ["awesome_pot", "tool_base", "takeable"];
var has_instance_props = true;

var classProps = {
	"collection_id"	: "",	// defined by takeable
	"making_type"	: "cooking",	// defined by tool_base (overridden by awesome_pot)
	"required_skill"	: "masterchef_1",	// defined by tool_base (overridden by awesome_pot)
	"points_capacity"	: "100",	// defined by tool_base (overridden by awesome_pot)
	"display_wear"	: "1",	// defined by tool_base (overridden by awesome_pot)
	"can_repair"	: "1"	// defined by tool_base
};

function initInstanceProps(){
	this.instanceProps = {};
	this.instanceProps.points_remaining = "100";	// defined by tool_base (overridden by awesome_pot)
...
verbs.use = { // defined by awesome_pot
	"name"				: "use",
	"ok_states"			: ["in_pack"],
	"requires_target_pc"		: false,
	"requires_target_item"		: false,
	...
	"is_emote"			: false,
	"sort_on"			: 56,
	"tooltip"			: "Awesome!! Heh. You know $recipes_known recipes",
	"is_drop_target"		: false,
	"making"			: {
		slots		: 4,
		try_wait	: 5,
		recipes		: [22, 30, 31, 32, 33, 35, 37, 38, 39, 40, 85, 93, 94, 143, 224, 305, 341, 342, 343, 345, 346, 347, 349],
		skills		: ["masterchef_1", "masterchef_2"],
		can_discover	: false,
...
function getHitPointModifier(pc){ // defined by awesome_pot
	if (pc.imagination_has_upgrade('master_chef_tool_wear')) return 0.5;

	return 1;
}

function onMakingComplete(pc, recipe_id, count){ // defined by awesome_pot
	var chance_of_bonus = 0.10;
	var bonus_base_cost_percentage = 0.20;
	var upgrade_id = 'master_chef_imagination';
...
function getDescExtras(pc){
	var out = [];
	if (pc && (!pc.skills_has("masterchef_1"))) out.push([1, "You need the skill <a href=\"\/skills\/47\/\" glitch=\"skill|masterchef_1\">Master Chef I<\/a> to use this."]);
	if (pc && (!pc.achievements_has("golden_ladle_award"))) out.push([2, "Additional recipes will become available if you use the Awesome Pot more."]);
...
function getAssetInfo(){
	return {
		'position': {"x":-30,"y":-46,"w":58,"h":46},
		'thumb': "",
	};
};
...
var itemDef = {
	...
	asset_swf_v	: "\/c2.glitch.bz\/items\/2012-04\/awesome_pot-1334339360.swf",
	admin_props	: true,
	obey_physics	: true,
	in_background	: false,
	in_foreground	: false,
