...
var label = "Phantom Cubimal";
var version = "1353719713";
var name_single = "Phantom Cubimal";
var name_plural = "Phantom Cubimals";
var article = "a";
var description = "It's a Phantom Cubimal! Collect all Series 2 Cubimals!";
var is_hidden = false;
var has_info = true;
...
var base_cost = 0;
var input_for = [];
var parent_classes = ["npc_cubimal_phantom", "npc_cubimal_base", "npc"];
var has_instance_props = true;

var classProps = {
	"got_quest_text"	: "I've got something for you...",	// defined by npc
	"no_quest_text"	: "",	// defined by npc
	"set_free_img"	: "750"	// defined by npc_cubimal_base (overridden by npc_cubimal_phantom)
};
...
function getAssetInfo(){
	return {
		...
		'thumb': "",
	};
};
...
var itemDef = {
	...
	asset_swf_v	: "\/c2.glitch.bz\/items\/2012-07\/npc_cubimal_phantom-1343768097.swf",
	admin_props	: true,
	obey_physics	: false,
	in_background	: false,
	in_foreground	: true,
...
log.info("npc_cubimal_phantom.js LOADED");
