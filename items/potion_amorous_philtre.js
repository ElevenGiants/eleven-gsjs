...
var label = "Amorous Philtre";
var version = "1355086256";
var name_single = "Amorous Philtre";
var name_plural = "Amorous Philtres";
var article = "an";
var description = "A sensual - and highly infectious - blend of natural ingredients that stimulate the positive mood-memory receptors of the Glitchate Brain. Smells like macaroons.";
var is_hidden = false;
var has_info = true;
...
var base_cost = 750;
var input_for = [];
var parent_classes = ["potion_amorous_philtre", "potion_base", "tool_base", "takeable"];
...
var classProps = {
	...
	"can_quaff"	: "1",	// defined by potion_base (overridden by potion_amorous_philtre)
	"pour_tooltip"	: "",	// defined by potion_base
	"quaff_tooltip"	: "Get the feeling of love."	// defined by potion_base (overridden by potion_amorous_philtre)
};
...
function canQuaff(pc){ // defined by potion_amorous_philtre
	if (pc.buffs_has('feeling_called_love')) return {ok:0, error:'This doesn\'t fit my plans, no.'};

	return {ok:1};
}

function onQuaff(pc){ // defined by potion_amorous_philtre
...
function getAssetInfo(){
	return {
		...
		'thumb': "",
	};
};
...
var itemDef = {
	...
	asset_swf_v	: "\/c2.glitch.bz\/items\/2012-04\/potion_amorous_philtre-1334269690.swf",
	admin_props	: true,
	obey_physics	: true,
	in_background	: false,
	in_foreground	: false,
...
log.info("potion_amorous_philtre.js LOADED");
