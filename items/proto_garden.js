...
var label = "In-Progress Garden";
var version = "1325629285";
var name_single = "In-Progress Garden";
var name_plural = "In-Progress Gardens";
var article = "an";
var description = "";
var is_hidden = false;
var has_info = false;
...
var base_cost = 0;
var input_for = [];
var parent_classes = ["proto_garden", "proto"];
var has_instance_props = true;

var classProps = {
	"job_class_id"	: "job_proto_garden,job_proto_garden2",	// defined by proto (overridden by proto_garden)
	"width"	: "512"	// defined by proto (overridden by proto_garden)
};

function initInstanceProps(){
	this.instanceProps = {};
	this.instanceProps.item_class = "garden_new";	// defined by proto (overridden by proto_garden)
}
...
function afterCreationAnimation(){ // defined by proto_garden
	// make it selectable now! (it is made not selectable in onCreate)
	this.not_selectable = false;
	this.setAndBroadcastState('state_5_crop');
	this.setJobData();
}
...
function parent_afterCreationAnimation(){ // defined by proto
	// make it selectable now! (it is made not selectable in onCreate)
	this.not_selectable = false;
...
var itemDef = {
	...
	asset_swf_v	: "\/c2.glitch.bz\/items\/2011-11\/proto_garden-1321489660.swf",
	admin_props	: true,
	obey_physics	: false,
	in_background	: false,
	in_foreground	: false,
