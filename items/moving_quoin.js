var label = "Moving Coin";
var version = "1351476850";
var name_single = "Moving Coin";
var name_plural = "Moving Coins";
var article = "a";
var description = "";
var is_hidden = false;
var has_info = false;
...
var base_cost = 0;
var input_for = [];
var parent_classes = ["moving_quoin", "quoin"];
...
function initInstanceProps(){
	this.instanceProps = {};
	this.instanceProps.respawn_time = "100000000000";	// defined by quoin (overridden by moving_quoin)
	...
	this.instanceProps.velocity = "0";	// defined by moving_quoin
	this.instanceProps.direction = "up";	// defined by moving_quoin
}
...
var instancePropsDef = {
	...
	velocity : ["The velocity in pixels \/ second"],
	direction : ["Direction to move this coin"],
};
...
function onDoneMoving(){ // defined by moving_quoin
	this.apiDelete();
}

function onStartMoving(velocity, direction){ // defined by moving_quoin
	//log.info("Moving coin got "+velocity+" and "+direction);
	...
	this.setInstanceProp("velocity", velocity);
	this.setInstanceProp("direction", direction);


	if (direction == "left") {
		this.apiMoveToXY(left, this.y, velocity, "onDoneMoving");
	}
	else if (direction == "right") { 
		this.apiMoveToXY(right, this.y, velocity, "onDoneMoving");
	}
	else if (direction == "up") {
		this.apiMoveToXY(this.x, top, velocity, "onDoneMoving");
	}
	else if (direction == "down") {
		this.apiMoveToXY(this.x, bottom, velocity, "onDoneMoving");
	}
	else {
		log.error("Moving quoin created with unknown direction "+direction);
	}
}
...
function getAssetInfo(){
	return {
		...
		'thumb': "",
	};
};
...
var itemDef = {
	...
	asset_swf_v	: "\/c2.glitch.bz\/items\/2012-03\/moving_quoin-1333150707.swf",
	admin_props	: true,
	obey_physics	: false,
	in_background	: false,
	in_foreground	: false,
...
log.info("moving_quoin.js LOADED");
