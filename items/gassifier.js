...
var name_single = "Gassifier";
var name_plural = "Gassifiers";
var article = "a";
var description = "An ergonomically correct gassifier. It can turn general vapour into much more exciting gases.";
var is_hidden = false;
var has_info = true;
...
var base_cost = 150;
var input_for = [];
var parent_classes = ["gassifier", "tool_base", "takeable"];
var has_instance_props = true;

var classProps = {
	"collection_id"	: "",	// defined by takeable
	"making_type"	: "transmogrification",	// defined by tool_base (overridden by gassifier)
	"required_skill"	: "gasmogrification_1",	// defined by tool_base (overridden by gassifier)
...
verbs.gassify = { // defined by gassifier
	"name"				: "gassify",
	"ok_states"			: ["in_pack"],
	"requires_target_pc"		: false,
	"requires_target_item"		: false,
	...
	"is_emote"			: false,
	"sort_on"			: 56,
	"tooltip"			: "Make all kinds of gas",
	"is_drop_target"		: false,
	"making"			: {
		slots		: 4,
		try_wait	: 5,
		recipes		: [133, 134, 135, 136, 137],
		skills		: [],
		can_discover	: false,
	...
	"conditions"			: function(pc){
		...
		return pc.making_check_allowed(this, "gassify");
	},
	"effects"			: function(pc){

		return pc.making_get_effects(this, "gassify");
	},
	"handler"			: function(pc, msg, suppress_activity){

		return pc.making_open_interface(this, "gassify");
	}
};

function onMakingComplete(pc, recipe_id, count){ // defined by gassifier
	var chance_of_bonus = 0.10;
	var bonus_base_cost_percentage = 0.12;
	var upgrade_id = 'gassifying_imagination';
...
function getDescExtras(pc){
	var out = [];
	if (pc && (!pc.skills_has("gasmogrification_1"))) out.push([2, "You can use this, but it's much better to learn <a href=\"\/skills\/20\/\" glitch=\"skill|gasmogrification_1\">Gasmogrification<\/a> first."]);
...
function getAssetInfo(){
	return {
		'position': {"x":-27,"y":-48,"w":53,"h":49},
		'thumb': "\nGbm5uXb6P8f2p5fsXr3+B1KSKzEYRY4sAAAAAElFTkSuQmCC",
	};
};
...
var itemDef = {
	...
	asset_swf_v	: "\/c2.glitch.bz\/items\/2012-04\/gassifier-1334256111.swf",
	admin_props	: true,
	obey_physics	: true,
	in_background	: false,
	in_foreground	: false,
