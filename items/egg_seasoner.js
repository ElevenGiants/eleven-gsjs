...
var label = "Egg Seasoner";
var version = "1355086256";
var name_single = "Egg Seasoner";
var name_plural = "Egg Seasoners";
var article = "an";
var description = "An Egg Seasoner is an important tool for seasoning and incubating eggs that hatch into all kinds of exciting animals.";
var is_hidden = false;
var has_info = true;
...
var base_cost = 175;
var input_for = [];
var parent_classes = ["egg_seasoner", "tool_base", "takeable"];
var has_instance_props = true;

var classProps = {
	"collection_id"	: "",	// defined by takeable
	"making_type"	: "",	// defined by tool_base (overridden by egg_seasoner)
	"required_skill"	: "animalhusbandry_1",	// defined by tool_base (overridden by egg_seasoner)
...
verbs.use = { // defined by egg_seasoner
	"name"				: "use",
	"ok_states"			: ["in_pack"],
	"requires_target_pc"		: false,
	"requires_target_item"		: false,
...
function getDescExtras(pc){
	var out = [];
	if (pc && (!pc.skills_has("animalhusbandry_1"))) out.push([1, "You need the skill <a href=\"\/skills\/30\/\" glitch=\"skill|animalhusbandry_1\">Animal Husbandry<\/a> to use this."]);
...
function getAssetInfo(){
	return {
		...
		'thumb': "",
	};
};
...
var itemDef = {
	...
	asset_swf_v	: "\/c2.glitch.bz\/items\/2012-06\/egg_seasoner-1338838094.swf",
	admin_props	: true,
	obey_physics	: true,
	in_background	: false,
	in_foreground	: false,
...
log.info("egg_seasoner.js LOADED");
