...
var label = "Elixir of Avarice";
var version = "1355086256";
var name_single = "Elixir of Avarice";
var name_plural = "Elixirs of Avarice";
var article = "an";
var description = "A natural blend that increases one's appetite for Quoins. Dosage: effective up to one potion per day.";
var is_hidden = false;
var has_info = true;
...
var base_cost = 1250;
var input_for = [];
var parent_classes = ["potion_elixir_of_avarice", "potion_base", "tool_base", "takeable"];
...
var classProps = {
	...
	"can_quaff"	: "1",	// defined by potion_base (overridden by potion_elixir_of_avarice)
	"pour_tooltip"	: "",	// defined by potion_base
	"quaff_tooltip"	: "Become a crazy quoin collector."	// defined by potion_base (overridden by potion_elixir_of_avarice)
};
...
function canQuaff(pc){ // defined by potion_elixir_of_avarice
	//if (!pc.achievements_has('numismatizer_leprechaun_class')) return {ok:0, error:'You must be a Numismatizer, Leprechaun Class to drink this.'};
	if (pc.buffs_has('crazy_coin_collector')) return {ok:0, error:'You are already collecting coins like crazy.'};

	return {ok:1};
}

function onQuaff(pc){ // defined by potion_elixir_of_avarice
	pc.buffs_apply('crazy_coin_collector');

	return {ok: 1, msg: 'Your quoin limit for today has increased by 50!'};
}
...
function getDescExtras(pc){
	var out = [];
	out.push([2, "The recipe for this will become available after you earn the achievement 'Numismatizer, Leprechaun Class'."]);
	...
	if (pc && pc.skills_has("potionmaking_1") && !pc.making_recipe_is_known("241")) out.push([2, "The recipe for this will become available after you use the <a href=\"\/items\/981\/\" glitch=\"item|cauldron\">Cauldron<\/a> a bit more."]);
	return out;
}
...
function getAssetInfo(){
	return {
		...
		'thumb': "",
	};
};
...
var itemDef = {
	...
	asset_swf_v	: "\/c2.glitch.bz\/items\/2012-04\/potion_elixir_of_avarice-1334274719.swf",
	admin_props	: true,
	obey_physics	: true,
	in_background	: false,
	in_foreground	: false,
...
log.info("potion_elixir_of_avarice.js LOADED");
