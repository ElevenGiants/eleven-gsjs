...
var name_single = "Chair";
var name_plural = "Chairs";
var article = "a";
var description = "The perfect chair for those who like the idea of sitting briefly and with utmost caution. Upgrading recommended for those who like highfalutin' ideas like \"comfort\" and \"aesthetics\".";
var is_hidden = false;
var has_info = true;
...
var base_cost = 450;
var input_for = [];
var parent_classes = ["furniture_chair", "furniture_base"];
var has_instance_props = true;

var classProps = {
	"placement_set"	: "chair,bookshelf",	// defined by furniture_base (overridden by furniture_chair)
...
function getFurnitureBaseGeo(){ // defined by furniture_chair
	//
	// this code generated by the furniture plat editor - do not overwrite!
	//

	return { 'plats': {"0":{"end":{"y":-28,"x":22},"start":{"y":-28,"x":-27},"platform_pc_perm":-1,"platform_item_perm":-1}},
	         'walls': null
	};
}
...
function getAssetInfo(){
	return {
		'position': {"x":-38,"y":-76,"w":77,"h":92},
		'thumb': "",
	};
};
...
var itemDef = {
	...
	asset_swf_v	: "\/c2.glitch.bz\/items\/2012-06\/furniture_chair-1341006646.swf",
	admin_props	: true,
	obey_physics	: false,
	in_background	: false,
	in_foreground	: false,
...
log.info("furniture_chair.js LOADED");
