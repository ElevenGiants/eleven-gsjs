...
var base_cost = 0;
var input_for = [];
var parent_classes = ["wood_tree"];
var has_instance_props = true;

var classProps = {
	"pc_action_distance"	: "50"	// defined by wood_tree
};
...
function onDie(){ // defined by wood_tree
	if (this.is_poisoned){
...
function onLoad(){ // defined by wood_tree
...
function getDescExtras(pc){
	...
	out.push([2, "You can grow this by planting a <a href=\"\/items\/743\/\" glitch=\"item|bean_wood\">Wood Tree Bean<\/a> in a <a href=\"\/items\/94\/\" glitch=\"item|patch\">Patch<\/a>."]);
	out.push([2, "Harvesting this will yield <a href=\"\/items\/211\/\" glitch=\"item|plank\">Planks<\/a>."]);
	return out;
}
...
function getAssetInfo(){
	return {
		'position': {"x":-32,"y":-138,"w":78,"h":138},
		'thumb': "",
	};
};
...
var itemDef = {
	...
	asset_swf_v	: "\/c2.glitch.bz\/items\/2012-03\/wood_tree-1332709380.swf",
	admin_props	: true,
	obey_physics	: false,
	in_background	: true,
	in_foreground	: false,
