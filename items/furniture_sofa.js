...
var name_single = "Sofa";
var name_plural = "Sofas";
var article = "a";
var description = "The phrase \"sofa: so good\" is not about this sofa, which is not, essentially, a good sofa. But with a little upgrading, it could be.";
var is_hidden = false;
var has_info = true;
...
var base_cost = 1500;
var input_for = [];
var parent_classes = ["furniture_sofa", "furniture_base"];
var has_instance_props = true;

var classProps = {
	"placement_set"	: "bookshelf,chair",	// defined by furniture_base (overridden by furniture_sofa)
...
function getFurnitureBaseGeo(){ // defined by furniture_sofa
	//
	// this code generated by the furniture plat editor - do not overwrite!
	//

	return { 'plats': {"0":{"platform_pc_perm":-1,"platform_item_perm":-1,"end":{"y":-21,"x":105},"start":{"y":-21,"x":-105}}},
	         'walls': null
	};
}
...
function getAssetInfo(){
	return {
		'position': {"x":-125,"y":-85,"w":249,"h":108},
		'thumb': "",
	};
};
...
var itemDef = {
	...
	asset_swf_v	: "\/c2.glitch.bz\/items\/2012-01\/furniture_sofa-1328042293.swf",
	admin_props	: true,
	obey_physics	: false,
	in_background	: false,
	in_foreground	: false,
...
log.info("furniture_sofa.js LOADED");
