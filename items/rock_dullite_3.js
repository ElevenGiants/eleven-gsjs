...
var base_cost = 0;
var input_for = [];
var parent_classes = ["rock_dullite_3", "rock_dullite", "mineable_rock"];
var has_instance_props = true;

var classProps = {
	"rock_type"	: "dullite",	// defined by mineable_rock (overridden by rock_dullite_3)
...
function getAssetInfo(){
	return {
		'position': {"x":-102,"y":-85,"w":205,"h":85},
		'thumb': "",
	};
};
...
var itemDef = {
	...
	asset_swf_v	: "\/c2.glitch.bz\/items\/2012-08\/rock_dullite_3-1345763335.swf",
	admin_props	: true,
	obey_physics	: false,
	in_background	: true,
	in_foreground	: false,
...
log.info("rock_dullite_3.js LOADED");
