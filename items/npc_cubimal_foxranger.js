...
var label = "Fox Ranger Cubimal";
var version = "1353719713";
var name_single = "Fox Ranger Cubimal";
var name_plural = "Fox Ranger Cubimals";
var article = "a";
var description = "It's a Fox Ranger Cubimal! Collect all Series 2 Cubimals!";
var is_hidden = false;
var has_info = true;
...
var base_cost = 0;
var input_for = [];
var parent_classes = ["npc_cubimal_foxranger", "npc_cubimal_base", "npc"];
var has_instance_props = true;

var classProps = {
	"got_quest_text"	: "I've got something for you...",	// defined by npc
	"no_quest_text"	: "",	// defined by npc
	"set_free_img"	: "500"	// defined by npc_cubimal_base (overridden by npc_cubimal_foxranger)
};
...
function getAssetInfo(){
	return {
		...
		'thumb': "",
	};
};
...
var itemDef = {
	...
	asset_swf_v	: "\/c2.glitch.bz\/items\/2012-07\/npc_cubimal_foxranger-1343767756.swf",
	admin_props	: true,
	obey_physics	: false,
	in_background	: false,
	in_foreground	: true,
