...
var name_single = "Pick";
var name_plural = "Picks";
var article = "a";
var description = "A relatively sturdy pick, without which mining cannot be done. A plain pick takes care of business, but it's not designed to last.";
var is_hidden = false;
var has_info = true;
...
var base_cost = 500;
var input_for = [];
var parent_classes = ["pick", "tool_base", "takeable"];
var has_instance_props = true;

var classProps = {
	"collection_id"	: "",	// defined by takeable
	"making_type"	: "",	// defined by tool_base
	"required_skill"	: "mining_1",	// defined by tool_base (overridden by pick)
	"points_capacity"	: "100",	// defined by tool_base (overridden by pick)
	"display_wear"	: "1",	// defined by tool_base (overridden by pick)
	"can_repair"	: "1"	// defined by tool_base
};

function initInstanceProps(){
	this.instanceProps = {};
	this.instanceProps.points_remaining = "100";	// defined by tool_base (overridden by pick)
...
function getAssetInfo(){
	return {
		'position': {"x":-25,"y":-15,"w":48,"h":21},
		'thumb': "",
	};
};
...
var itemDef = {
	...
	asset_swf_v	: "\/c2.glitch.bz\/items\/2012-05\/pick-1338251455.swf",
	admin_props	: true,
	obey_physics	: true,
	in_background	: false,
	in_foreground	: false,
