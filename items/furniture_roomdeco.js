...
var label = "Room Decoration";
var version = "1345763870";
var name_single = "Room Decoration";
var name_plural = "Room Decorations";
var article = "a";
var description = "To those with a layman's knowledge of art, this may look like a couple of pieces of wood roughly snailed together. But to those with their mind tuned to higher things (and the possibility of upgradiness) the true inner beauty of the piece reveals itself.";
var is_hidden = false;
var has_info = true;
...
var base_cost = 700;
var input_for = [];
var parent_classes = ["furniture_roomdeco", "furniture_base"];
var has_instance_props = true;

var classProps = {
	"placement_set"	: "bookshelf,chair,front",	// defined by furniture_base (overridden by furniture_roomdeco)
...
function getAssetInfo(){
	return {
		'position': {"x":-60,"y":-143,"w":120,"h":167},
		'thumb': "",
	};
};
...
var itemDef = {
	...
	asset_swf_v	: "\/c2.glitch.bz\/items\/2012-02\/furniture_roomdeco-1330373138.swf",
	admin_props	: true,
	obey_physics	: false,
	in_background	: false,
	in_foreground	: false,
...
log.info("furniture_roomdeco.js LOADED");
