...
var label = "Small Cabinet";
var version = "1351897068";
var name_single = "Small Cabinet";
var name_plural = "Small Cabinets";
var article = "a";
var description = "Rumour has it this cabinet, perceived as 'small' from the outside, is actually cavernous inside, and potentially capable of time travel. The rumours are false.";
var is_hidden = false;
var has_info = true;
...
var base_cost = 1500;
var input_for = [];
var parent_classes = ["bag_furniture_smallcabinet", "bag_furniture_cabinet_base", "furniture_base"];
var has_instance_props = true;

var classProps = {
	"placement_set"	: "bookshelf,chair",	// defined by furniture_base (overridden by bag_furniture_smallcabinet)
	"can_flip"	: "1",	// defined by furniture_base (overridden by bag_furniture_smallcabinet)
	"can_revert_to_base"	: "1",	// defined by furniture_base
	"width"	: "4",	// defined by bag_furniture_cabinet_base (overridden by bag_furniture_smallcabinet)
	"height"	: "4",	// defined by bag_furniture_cabinet_base (overridden by bag_furniture_smallcabinet)
	"rows_display"	: "4"	// defined by bag_furniture_cabinet_base (overridden by bag_furniture_smallcabinet)
};
...
function getFurnitureBaseGeo(){ // defined by bag_furniture_smallcabinet
	//
	// this code generated by the furniture plat editor - do not overwrite!
	//

	return { 'plats': {"0":{"end":{"x":65,"y":-41},"start":{"x":-65,"y":-41},"platform_pc_perm":-1,"platform_item_perm":-1}},
	         'walls': null
	};
}

// global block from bag_furniture_smallcabinet
var capacity = 16;
...
function getDescExtras(pc){
	var out = [];
	out.push([2, "This cabinet has 16 slots."]);
...
function getAssetInfo(){
	return {
		'position': {"x":-85,"y":-52,"w":169,"h":75},
		'thumb': "\n",
	};
};
...
var itemDef = {
	...
	asset_swf_v	: "\/c2.glitch.bz\/items\/2012-04\/bag_furniture_smallcabinet-1335289727.swf",
	admin_props	: true,
	obey_physics	: false,
	in_background	: false,
	in_foreground	: false,
