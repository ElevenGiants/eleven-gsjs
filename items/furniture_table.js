...
var name_single = "Table";
var name_plural = "Tables";
var article = "a";
var description = "It has four legs, like a pig. It isn't a pig. It's a plain old basic table. Do not nibble it.";
var is_hidden = false;
var has_info = true;
...
var base_cost = 1200;
var input_for = [];
var parent_classes = ["furniture_table", "furniture_base"];
var has_instance_props = true;

var classProps = {
	"placement_set"	: "chair",	// defined by furniture_base (overridden by furniture_table)
	"can_flip"	: "0",	// defined by furniture_base (overridden by furniture_table)
...
function getFurnitureBaseGeo(){ // defined by furniture_table
	//
	// this code generated by the furniture plat editor - do not overwrite!
	//

	return { 'plats': {"0":{"platform_pc_perm":-1,"start":{"y":-42,"x":-69},"end":{"y":-43,"x":67},"platform_item_perm":-1}},
	         'walls': null
	};
}

// global block from furniture_table
var plats = {
	0: {
		start: {
			x: 0,
...
function getAssetInfo(){
	return {
		'position': {"x":-111,"y":-60,"w":222,"h":85},
		'thumb': "",
	};
};
...
var itemDef = {
	...
	asset_swf_v	: "\/c2.glitch.bz\/items\/2012-05\/furniture_table-1336497919.swf",
	admin_props	: true,
	obey_physics	: false,
	in_background	: true,
	in_foreground	: false,
