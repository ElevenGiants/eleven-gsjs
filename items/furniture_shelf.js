...
var name_single = "Shelf";
var name_plural = "Shelves";
var article = "a";
var description = "The perfect shelf is longer, stronger and more attractive: this is not that shelf. It's like that shelf. It's shelf-ish. But there's nothing wrong with being a little shelfish.";
var is_hidden = false;
var has_info = true;
...
var base_cost = 750;
var input_for = [];
var parent_classes = ["furniture_shelf", "furniture_base"];
var has_instance_props = true;

var classProps = {
	"placement_set"	: "wall",	// defined by furniture_base (overridden by furniture_shelf)
	"can_flip"	: "1",	// defined by furniture_base (overridden by furniture_shelf)
...
function getFurnitureBaseGeo(){ // defined by furniture_shelf
	//
	// this code generated by the furniture plat editor - do not overwrite!
	//

	return { 'plats': {"0":{"platform_item_perm":-1,"end":{"y":-38,"x":101},"start":{"y":-38,"x":-103},"platform_pc_perm":-1}},
	         'walls': null
	};
}

// global block from furniture_shelf
var plats = {
	0: {
		start: {
			x: 0,
...
function getAssetInfo(){
	return {
		'position': {"x":-114,"y":-56,"w":226,"h":56},
		'thumb': "\n",
	};
};
...
var itemDef = {
	...
	asset_swf_v	: "\/c2.glitch.bz\/items\/2012-07\/furniture_shelf-1343187676.swf",
	admin_props	: true,
	obey_physics	: false,
	in_background	: false,
	in_foreground	: false,
...
log.info("furniture_shelf.js LOADED");
