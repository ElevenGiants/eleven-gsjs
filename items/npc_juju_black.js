...
var label = "Black Juju";
var version = "1347655948";
var name_single = "Black Juju";
var name_plural = "Black Jujus";
var article = "a";
var description = "";
var is_hidden = false;
var has_info = false;
...
var base_cost = 0;
var input_for = [];
var parent_classes = ["npc_juju_black", "npc_juju_base", "npc_walkable", "npc"];
var has_instance_props = true;

var classProps = {
	"got_quest_text"	: "I've got something for you...",	// defined by npc
	"no_quest_text"	: "",	// defined by npc
	"walk_type"	: "roam"	// defined by npc_walkable (overridden by npc_juju_black)
};
...
function idle(){ // defined by npc_juju_black
	this.setAndBroadcastState(choose_one(['idle1', 'idle2']));
}

function onCreate(){ // defined by npc_juju_black
	this.initInstanceProps();
	this.setAndBroadcastState('spawn');
	this.parent_onCreate();
}

function stopMoving(){ // defined by npc_juju_black
	this.apiStopMoving();
...
function teleportIn(){ // defined by npc_juju_base
	this.visible = false;
	this.apiSetTimer('appear', randInt(0, 1000));
}

function teleportOut(){ // defined by npc_juju_base
...
function parent_idle(){ // defined by npc_juju_base
	this.setAndBroadcastState(choose_one(['idle1', 'idle2']));
}
...
function parent_stopMoving(){ // defined by npc_juju_base
	this.apiStopMoving();
...
var itemDef = {
	...
	asset_swf_v	: "\/c2.glitch.bz\/items\/2010-04\/1270164047-9774.swf",
	admin_props	: true,
	obey_physics	: false,
	in_background	: false,
	in_foreground	: true,
...
log.info("npc_juju_black.js LOADED");
