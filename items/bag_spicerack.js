...
var label = "Spice Rack";
var version = "1352136683";
var name_single = "Spice Rack";
var name_plural = "Spice Racks";
var article = "a";
var description = "A practical rack for storing spices.";
var is_hidden = false;
var has_info = true;
...
var base_cost = 500;
var input_for = [];
var parent_classes = ["bag_spicerack", "bag_generic", "takeable"];
var has_instance_props = false;

var classProps = {
	"collection_id"	: "",	// defined by takeable
	"can_specialize"	: "false"	// defined by bag_generic (overridden by bag_spicerack)
};
...
function canContain(stack){ // defined by bag_spicerack
	if (stack.getProp('is_spice')) return stack.getProp('count');

	return 0;
}

function getCustomBagCategories(){ // defined by bag_spicerack
	return ['spice'];
}

function onCreate(){ // defined by bag_spicerack
...
function getDescExtras(pc){
	...
	out.push([2, "This can be purchased from a <a href=\"\/items\/1000006\/\" glitch=\"item|npc_streetspirit_kitchen_tools\">Kitchen Tools Vendor<\/a>."]);
	return out;
}
...
function getAssetInfo(){
	return {
		'position': {"x":-33,"y":-27,"w":64,"h":28},
		'thumb': "\n",
	};
};
...
var itemDef = {
	...
	asset_swf_v	: "\/c2.glitch.bz\/items\/2012-04\/bag_spicerack-1334339686.swf",
	admin_props	: false,
	obey_physics	: true,
	in_background	: false,
	in_foreground	: false,
