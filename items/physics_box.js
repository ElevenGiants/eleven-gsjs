...
var base_cost = 0;
var input_for = [];
var parent_classes = ["physics_box"];
...
function initInstanceProps(){
	this.instanceProps = {};
	this.instanceProps.gravity = "1.0";	// defined by physics_box
	this.instanceProps.vx_max = "1.0";	// defined by physics_box
	this.instanceProps.vy_max = "1.0";	// defined by physics_box
	this.instanceProps.vy_jump = "1.0";	// defined by physics_box
	this.instanceProps.is_permanent = "0";	// defined by physics_box
	this.instanceProps.duration = "0";	// defined by physics_box
	this.instanceProps.vx_accel_add_in_floor = "1.0";	// defined by physics_box
	this.instanceProps.vx_accel_add_in_air = "1.0";	// defined by physics_box
	this.instanceProps.friction_floor = "1.0";	// defined by physics_box
	this.instanceProps.friction_air = "1.0";	// defined by physics_box
	this.instanceProps.friction_thresh = "1.0";	// defined by physics_box
	this.instanceProps.pc_scale = "1";	// defined by physics_box
	this.instanceProps.jetpack = "0";	// defined by physics_box
	this.instanceProps.y_cam_offset = "1.0";	// defined by physics_box
}
...
function runPhysics(pc){ // defined by physics_box
	log.info('Player '+pc+' activated physics changer '+this.tsid);
