...
var label = "Mountaineering Permit Test";
var version = "1326922741";
var name_single = "Mountaineering Permit Test";
var name_plural = "Mountaineering Permit Tests";
var article = "a";
...
var base_cost = 0;
var input_for = [];
var parent_classes = ["mountaineering_permit2", "party_pack", "takeable"];
...
function initInstanceProps(){
	this.instanceProps = {};
	this.instanceProps.mountain_id = "mountain3";	// defined by mountaineering_permit2
}

var instancePropsDef = {
	mountain_id : ["Which mountain this goes to "],
};
...
function activate(pc){ // defined by mountaineering_permit2
	var template = this.getInstanceProp('mountain_id');
...
var itemDef = {
	...
	asset_swf	: "\/c2.glitch.bz\/items\/missing.swf",
...
log.info("mountaineering_permit2.js LOADED");
