...
var label = "Cactus Cubimal";
var version = "1353719712";
var name_single = "Cactus Cubimal";
var name_plural = "Cactus Cubimals";
var article = "a";
var description = "It's a Cactus Cubimal! Collect all Series 1 Cubimals!";
var is_hidden = false;
var has_info = true;
...
var base_cost = 0;
var input_for = [];
var parent_classes = ["npc_cubimal_cactus", "npc_cubimal_base", "npc"];
var has_instance_props = true;

var classProps = {
	"got_quest_text"	: "I've got something for you...",	// defined by npc
	"no_quest_text"	: "",	// defined by npc
	"set_free_img"	: "1000"	// defined by npc_cubimal_base (overridden by npc_cubimal_cactus)
};
...
function getAssetInfo(){
	return {
		'position': {"x":-16,"y":-25,"w":32,"h":26},
		'thumb': "\nXqufAAAAAElFTkSuQmCC",
	};
};
...
var itemDef = {
	...
	asset_swf_v	: "\/c2.glitch.bz\/items\/2012-07\/npc_cubimal_cactus-1343767274.swf",
	admin_props	: true,
	obey_physics	: false,
	in_background	: false,
	in_foreground	: true,
...
log.info("npc_cubimal_cactus.js LOADED");
